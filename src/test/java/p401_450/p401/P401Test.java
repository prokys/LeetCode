...
public class P401Test {
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void testReadBinaryWatch(int bits, List<String> result) {

        List<String> resultSorted = new ArrayList<>(result);
        Collections.sort(resultSorted);
        List<String> list = readBinaryWatch(bits);
        Collections.sort(list);

        Assertions.assertEquals(resultSorted, list);
